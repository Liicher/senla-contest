...
когда игрок угадывает слово или теряет все жизни.
...
Рисовать в консоли человечка на виселице как иллюстрацию количества жизней (как это обычно бывает в «Виселице»)
не обязательно, но будет приветствоваться.
**/

package hangman;

import hangman.model.ConsoleHangman;

public class Application {
	public static void main(String[] args) {
		new ConsoleHangman().starter();
	}
}
